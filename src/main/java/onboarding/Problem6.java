...
public class Problem6 {
    ...
    static class MapFactory {
        ...
        public Map<String, Set<Integer>> generateIndexMap(List<List<String>> splitNameForms) {
    ...
    static class Result {
        ...
        public List<String> generateResult(Map<String, Set<Integer>> indexMap, List<List<String>> forms) {
        ...
        private void addEmail(Set<String> result, Set<Integer> indexes, List<List<String>> forms) {
            if (indexes.size() <= 1) {
                return;
            }
